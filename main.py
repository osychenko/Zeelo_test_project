...
def get_cities_list(country_code="gb"):
    nrows = 10
    ...
    print("results=", pd.DataFrame(results_fields).drop(drop_columns, axis=1))
...
def get_geo_data():
    ...
    loc_orig = "Disneyland"
    loc_dest = "Universal+Studios+Hollywood"
    transp_mode = "driving" # driving is default

    url = f"https://maps.googleapis.com/maps/api/directions/json?" \
          f"origin={loc_orig}&destination={loc_dest}" \
